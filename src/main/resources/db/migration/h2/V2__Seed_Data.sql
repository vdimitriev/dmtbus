...
('Kocani', 'Кочани', '2300', 41.9164, 22.4128, (SELECT id FROM countries WHERE code = 'MK')),
('Kicevo', 'Кичево', '6250', 41.5128, 20.9589, (SELECT id FROM countries WHERE code = 'MK')),
('Stip', 'Штип', '2000', 41.7458, 22.1903, (SELECT id FROM countries WHERE code = 'MK')),
...
('Nis', 'Ниш', '18000', 43.3209, 21.8958, (SELECT id FROM countries WHERE code = 'RS')),
...
('Tirana', 'Tirane', '1001', 41.3275, 19.8187, (SELECT id FROM countries WHERE code = 'AL')),
('Pristina', 'Prishtine', '10000', 42.6629, 21.1655, (SELECT id FROM countries WHERE code = 'XK'));
...
('Ohrid Bus Station', 'Автобуска станица Охрид', 'Turisticka bb', 41.1231, 20.8016, '+389 46 260 339', true, (SELECT id FROM cities WHERE name = 'Ohrid')),
...
('Strumica Bus Station', 'Автобуска станица Струмица', 'Ul. Goce Delcev bb', 41.4378, 22.6427, '+389 34 345 678', true, (SELECT id FROM cities WHERE name = 'Strumica')),
('Gostivar Bus Station', 'Автобуска станица Гостивар', 'Ul. Braka Ginoski bb', 41.7958, 20.9086, '+389 42 213 456', true, (SELECT id FROM cities WHERE name = 'Gostivar')),
('Stip Bus Station', 'Автобуска станица Штип', 'Ul. Vasil Glavinov bb', 41.7458, 22.1903, '+389 32 392 234', true, (SELECT id FROM cities WHERE name = 'Stip')),
...
('Belgrade Bus Station', 'Београдска аутобуска станица', 'Zeleznicka 4', 44.7866, 20.4489, '+381 11 2636 299', true, (SELECT id FROM cities WHERE name = 'Belgrade')),
...
('D004', 'Skopje - Strumica', 'Line from Skopje to Strumica via Stip', false, true, 145, 150,
...
INSERT INTO bus_line_stops (stop_order, arrival_offset_minutes, departure_offset_minutes, distance_from_origin_km, bus_line_id, bus_station_id) VALUES
(1, 80, 85, 80, (SELECT id FROM bus_lines WHERE line_number = 'D004'), (SELECT id FROM bus_stations WHERE name = 'Stip Bus Station'));
